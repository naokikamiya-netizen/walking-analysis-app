# ==========================================================
#  app.py - 歩行分析アプリ (真・最終完成版 - デザイン調整済み)
# ==========================================================
...
def analyze_walking(video_path, progress_bar, status_text, should_rotate):
    ...
    for i in range(total_frames):
        ...
        ax_g.set_ylim(-y_limit, y_limit); ax_g.grid(True, linestyle=':', color='gray', alpha=0.7); ax_g.legend(fontsize=10, loc='upper right')
...
def display_results():
    ...
    # ★★★ デザイン調整：helpテキストを追加して、数値を大きく見せる ★★★
